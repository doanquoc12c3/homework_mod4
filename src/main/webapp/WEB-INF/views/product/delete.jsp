...
<div class = "container">
    ...
    <div class="card">
        <h5 class="card-header"><i class="far fa-eraser"></i>Delete Product Information</h5>
        <div class="card-body">
            <form method="post">
                <div class="mb-3">
                ...
                <div class="input-group mb-3">
                    <label class="input-group-text" for="exampleInputEmail5">Image URL</label>
                    <input type="text" class="form-control" id="exampleInputEmail5" name = "description" value="${product.imgURL}" aria-describedby="emailHelp" disabled>
                </div>
