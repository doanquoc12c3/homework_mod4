...
<div class = "container">
    ...
    <div class="card">
        <h5 class="card-header"><i class="fal fa-file-plus fa-2x"></i> Add new product</h5>
        <div class="card-body">
            <form method="post" action="/products/create">
                ...
                <div class="mb-3">
                    <label for="exampleInputEmail5" class="form-label">Image URL</label>
                    <input type="text" class="form-control" id="exampleInputEmail5" name = "imgURL" aria-describedby="emailHelp">
                </div>
