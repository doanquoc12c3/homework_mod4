...
<div class = "container">
    ...
    <div class="card">
        <h5 class="card-header"><i class="fal fa-edit"></i> Edit product information</h5>
        <div class="card-body">
            <form method="post">
                <div class="mb-3">
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="text" id = "inputGroupSelect01" name ="imgURL" value="${product.imgURL}" aria-describedby="emailHelp">
                </div>
